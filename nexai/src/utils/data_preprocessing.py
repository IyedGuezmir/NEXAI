...
def preprocess_ad_data(ad_data: pd.DataFrame) -> pd.DataFrame:
    ...
    ad_data[numerical_features] = scaler.fit_transform(ad_data[numerical_features])
     # Save the scaler
    joblib.dump(scaler, "nexai/src/models/machine_learning_models/encoders/numerical_scaler.pkl")
    ...
    for col in categorical_features:
        ...
        encoders[col] = le
        joblib.dump(le, f"nexai/src/models/machine_learning_models/encoders/{col}_encoder.pkl")
    return ad_data
