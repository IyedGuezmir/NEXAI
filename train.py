...
import pandas as pd
from nexai.src.utils.data_preprocessing import preprocess_ad_data, split_ad_data
from nexai.src.utils.model_training import train_ctr_model, evaluate_ctr_model
import joblib

# Load your raw ad data
data = pd.read_csv("nexai/src/data/Ad_Performance/Social_Media_Advertising.csv")
